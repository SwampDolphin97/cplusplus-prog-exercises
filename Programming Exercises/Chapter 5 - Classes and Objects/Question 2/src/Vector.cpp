...
void Vector::modifyVector() {
	...
	for (int i = 0; i < dimensions; i++) {
		...
		case x:
			cout << "Enter the new value of the vector in x-direction (a): "
					<< flush;
			break;
		case y:
			cout << "Enter the new value of the vector in y-direction (b): "
					<< flush;
			break;
		case z:
			cout << "Enter the new value of the vector in z-direction (c): "
					<< flush;
			break;
		}
		cin >> values[i];
